...
export const OurPrinciplesSection = () => {
  return (
    <section className="lg:px-[112px] w-full flex flex-col items-center justify-center px-5 py-20 border-t border-b border-gray-200">
      ...
      <div className="grid lg:grid-cols-3 grid-cols-1 gap-10 mt-20 place-content-stretch max-w-[1216px]">
        {principles.map((item) => {
          return (
            <div key={item.title}>
...
const principles: PrinciplesProps[] = [
  {
    ...
    title: "Open sourced",
    description:
      "We firmly believe in sharing knowledge, fostering collaboration, and democratizing innovation. Everything we create is open source, ensuring that our technology is accessible, adaptable, and a collective force for positive change throughout the entirety of Web3.",
  },
  {
    icon: <CheckBadgeIcon className="text-gray-400 w-5 h-5 shrink-0" />,
    title: "Freely licensed",
    description:
      "We agree to release all work produced within this funding program under a permissive open-source license. This license ensures the freedom to use, modify, and redistribute while also permitting proprietary derivative works, promoting a culture of innovation.",
  },
  {
    icon: (
      <svg
    ...
    title: "Infrastructure for the ENS ecosystem",
    description:
      "We are fully committed to crafting robust solutions tailored exclusively for the ENS ecosystem, ensuring the protocol’s stability, resilience, and continued growth. Our mission is to empower ENS to become the bedrock upon which the internet of identity can thrive.",
  },
];
