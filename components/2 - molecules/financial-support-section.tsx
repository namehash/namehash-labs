...
export const FinancialSupportSection = () => {
  return (
    ...
    >
      <div
        className="flex flex-col gap-5 items-center justify-center w-full max-w-[1216px] py-8 px-8 rounded-[8px]"
        style={{
          background:
      ...
      >
        <p className="text-2xl leading-8 font-semibold text-center">
