      ...
      <div className="w-full flex items-center justify-between py-5 max-w-[1216px]">
        ...
        <div className="flex items-center justify-center gap-3">
          <a
            ...
            className="px-[16px] py-[9px] bg-white text-black border border-black rounded-[8px] text-sm leading-5 font-medium hover:bg-gray-100 transition-colors duration-200"
            style={{
